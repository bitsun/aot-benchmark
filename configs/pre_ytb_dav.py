...
from .models import deaots,deaotl,deaott
...
class DeAOTSEngineConfig(DefaultEngineConfig):
    def __init__(self, exp_name='default'):
        super().__init__(exp_name, deaots.DefaultModelConfig())
        self.STAGE_NAME = 'PRE_YTB_DAV'
...
class DeAOTLEngineConfig(DefaultEngineConfig):
    def __init__(self, exp_name='default'):
        super().__init__(exp_name, deaotl.DefaultModelConfig())
        self.STAGE_NAME = 'PRE_YTB_DAV'
        ...
        self.PRETRAIN_MODEL = os.path.join(self.DIR_ROOT, 'result',
                                           self.EXP_NAME, pretrain_stage,
                                           'ema_ckpt', pretrain_ckpt)
class DeAOTTEngineConfig(DefaultEngineConfig):
    def __init__(self, exp_name='default'):
        super().__init__(exp_name, deaott.DefaultModelConfig())
        self.STAGE_NAME = 'PRE_YTB_DAV'
